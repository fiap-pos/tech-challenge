...
class BuscaPedidosPorPrioridadeUseCaseTest {
    ...
    void setUp() {
        ...
        buscaPedidosOrdenadosPorPrioridadeInputPort = new BuscaPedidosPorPrioridadeUseCase(buscaTodosPedidosOutputPort);
    }
    ...
    class buscaPedidosPorPrioridadeUseCase {
        ...
        void buscaPedidoPorPrioridade() {
            ...
            var listaPedidosBuscados = buscaPedidosOrdenadosPorPrioridadeInputPort.buscarPorPrioridade();
